function [sys,x0] = calc_ESN(t,x,u,flag,ESN,YIni)
...
% =========================================================================
if flag == 0
	ninput=4;                      % Número das entradas do processo (2 manipuladas + 2 processo)
...
elseif abs(flag) == 2
    ...
    uk = feature_scaling(u,u_max(1:4),u_min(1:4));
    ...
    yk_1 = feature_descaling(yk_aux,y_max(1:3),y_min(1:3));
